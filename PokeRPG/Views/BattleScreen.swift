...
struct BattleScreen: View {
    ...
    @State var Machoke = Pokemon(Nome: "Machoke", Lvl: 15, HP: 80, ATK: 100, DEF: 70, spATK: 50, spDEF: 60, SPD:45, type1: "fighting", Move1: Moves(Name:"Revenge", Power:60, pType:"fighting"), Move2: Moves(Name:"Knock Off", Power:65, pType:"dark"), Move3: Moves(Name:"Vital Throw", Power:70, pType:"fighting"), Move4: Moves(Name:"Strength", Power:80, pType:"normal"))
    
    @State var Golem = Pokemon(Nome: "Golem", Lvl: 16,HP: 80, ATK: 120, DEF: 130, spATK: 55, spDEF: 65, SPD:45, type1: "rock", type2:"ground", Move1: Moves(Name:"Rock Throw", Power:50, pType:"rock"), Move2: Moves(Name:"Tackle", Power:35, pType:"normal"), Move3: Moves(Name:"Earthquake", Power:100, pType:"ground"), Move4: Moves(Name:"Harden", Power:20, pType:"normal"))
    ...
    func getRandomBotAtk(Adv:Pokemon) -> Moves{
